...
async def decode_send(dut):
    ...
    dut.rr_request_decoder_data.rd.value = 23
    ...
    assert int(dut.request_decoder_send_queue_data.register.value) == 23
...
async def decode_recv(dut):
    ...
    assert int(dut.request_decoder_receive_queue_data.register.value) == 23
